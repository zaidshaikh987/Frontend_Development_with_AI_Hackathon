...
export function VoiceAssistantProvider({ children }: { children: React.ReactNode }) {
  ...
  // DISABLED: Using native Web Speech API instead of Gemini (works offline, no API key needed)
  const useGeminiRef = useRef(false) // Set to false to use browser's built-in speech recognition
